...
int main(int argc, char** argv) {
    ...
    //nes->loadProgram("roms/test/mapper/mmc3_test_2/rom_singles/1-clocking.nes");
    //nes->loadProgram("roms/test/mapper/mmc3_test_2/rom_singles/2-details.nes");
    //nes->loadProgram("roms/test/mapper/mmc3_test_2/rom_singles/3-A12_clocking.nes");
